...
function DoorsStartup(){
 ...
 if(bios.style.display =="none" ){
    ...
    //for github
    else if(document.location.protocol == "https:"){window.location = 'https://github.com/Ben-Worrall/doors98Startup/doors98Startup.html'}
...
function DoorsStartupBiosOPT(){
    ...
    //for github
    else if(document.location.protocol == "https:"){window.location = 'https://github.com/Ben-Worrall/Doors98/blob/242180c3cf969db34c1a9eb0eaf495e62535425a/doors98Startup/doors98Startup.html'}
